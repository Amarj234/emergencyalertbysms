          ...
          child: Column(
            children: [
              Container(
                  ...
                  child: Text("While there are many medications, medical devices, and surgical options to treat epilepsy, right now there are no known cures for epilepsy. However, incredible advancements in research have helped us understand the mechanisms that cause seizures better than at any other point in history") ),
              // Container(
              //   padding:const EdgeInsets.all(10),
